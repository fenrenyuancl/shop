...
<div class="container header">
	...
	<div class="span9">
<div class="headerAd">
					<img src="${pageContext.request.contextPath}/images/GeneralPurpose/header.jpg" alt="正品保障" title="正品保障" height="50" width="320">
</div>	</div>
		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					<dt>商城价:</dt>
					<dd>
						<strong>￥：<s:property value="model.listprice"/>元</strong>
							参 考 价：
							<del>￥<s:property value="model.unitcost"/>元</del>
					</dd>
				</dl>
					<dl>
						<dt>促销:</dt>
			...
			<form id="cartForm" method="post" action="${pageContext.request.contextPath}/cart_addCart.action ">
			...
			<div id="bar" class="bar">
				...
				<div id="introduction" name="introduction" class="introduction">
					<div class="title">
						<strong><s:property value="model.descn"/></strong>
					</div>
					<div>
